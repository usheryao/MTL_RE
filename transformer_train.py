...
from transformer_MTL import Transformer
...
tf.flags.DEFINE_string('data_path', './data/', 'path to load data')
...
tf.flags.DEFINE_float('best_auc',0.411156,'best auc')
